...
using log4net.Core;
using TempCon.Shell.Messages;

namespace TempCon.Shell.ViewModel
{
    public class LoggingViewModel : ViewModelBase
    {
        public LoggingViewModel()
        {
            ...
            Messenger.Default.Register<Log4NetMessage>(this, message =>
            {
                if (Application.Current == null) return;
                Application.Current.Dispatcher.BeginInvoke(DispatcherPriority.Background, new Action(() => ProcessMessage(message)));
            });
        }
